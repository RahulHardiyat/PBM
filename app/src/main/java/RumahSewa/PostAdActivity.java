...
//                SimpleDateFormat mdformat = new SimpleDateFormat("HH:mm:ss");
                ...
                if (adTitle.equals("") || adLocation.equals("") || rentFee.equals("") || address.equals("") ||
                    ...
                    Toast.makeText(PostAdActivity.this, "Isi semua kolom!", Toast.LENGTH_SHORT).show();
                } else {
...
//                                childUpdates.put("/User/" + userName, userValues);
                    ...
                    new AlertDialog.Builder(PostAdActivity.this).setMessage("anda telah mengepost!").show();
